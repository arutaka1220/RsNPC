...
import com.smallaswater.npc.utils.Language;
...
public class RsNPC extends PluginBase {
    ...
    public static final ThreadPoolExecutor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(Runtime
                                                                                                 .getRuntime()
                                                                                                 .availableProcessors(),
                                                                                         Runtime
                                                                                                 .getRuntime()
    ...
    public void onEnable() {
        ...
        try {
            Registries.ENTITY.registerCustomEntity(this,
                                                   new EntityRegistry.CustomEntityDefinition("rsnpc:npc",
                                                                                             "",
                                                                                             false,
                                                                                             true
                                                   ),
        ...
        if (files != null) {
            for (File file : files) {
                ...
                try {
                    ...
                    this
                            .getLogger()
                            .error(this.getLanguage().translateString("plugin.load.NPC.loadConfigError", npcName), e);
                    continue;
                }
                ...
                this
                        ...
                        .info(this
                                      .getLanguage()
                                      .translateString("plugin.load.NPC.loadComplete", rsNpcConfig.getName()));
            }
        }
        ...
        for (File file : files) {
            ...
            if (skinDataFile != null && skinDataFile.exists()) {
                ...
                try {
                    ...
                    this
                            .getLogger()
                            .error(this.getLanguage().translateString("plugin.load.skin.dataError", skinName), e);
                    continue;
                }
                ...
                try {
                    ...
                    if (skinJsonFile != null && skinJsonFile.exists()) {
                        Map<String, Object> skinJson = (new Config(this.getDataFolder() + "/Skins/" + skinName + "/skin.json",
                                                                   Config.JSON
                        )).getAll();
                        ...
                        switch (formatVersion) {
                            ...
                            case "1.12.0":
                                ...
                                if (geometryName.equals("nullvalue")) {
                                    this
                                            ...
                                            .error(this
                                                           .getLanguage()
                                                           .translateString("plugin.load.skin.jsonDataIncompatible",
                                                                            skinName
                                                           ));
                                } else {
                            ...
                            default:
                                this
                                        .getLogger()
                                        .warning("[" + skinJsonFile.getName() + "] 的版本格式为：" + formatVersion + "，正在尝试加载！");
                            case "1.10.0":
                            case "1.8.0":
                    ...
                    this
                            .getLogger()
                            .error(this.getLanguage().translateString("plugin.load.skin.jsonDataError", skinName), e);
                }
                ...
                if (skin.isValid()) {
                    ...
                    this
                            .getLogger()
                            .error(this.getLanguage().translateString("plugin.load.skin.loadFailure", skinName));
                }
            } else {
    ...
    public String getGeometryName(File file) {
        ...
        if (!originGeometry.getString("format_version").equals("1.12.0") && !originGeometry
                .getString("format_version")
                .equals("1.16.0")) {
            return "nullvalue";
        }
